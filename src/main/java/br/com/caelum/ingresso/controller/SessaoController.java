...
import br.com.caelum.ingresso.clients.CapaFilme;
...
public class SessaoController {
    ...
    @Autowired private ImdClient client;
    ...
    public ModelAndView lugares(@PathVariable("id") Integer id) {
        ...
        Sessao sessaoById = this.sessaoDao.getSessaoById(id);

        Optional<CapaFilme> capaFilme = this.client.buscaDetalheFilme(sessaoById.getFilme(), CapaFilme.class);

        view.addObject("sessao", sessaoById);
        view.addObject("imagemCapa", capaFilme.orElse(new CapaFilme()));
    ...
    public ModelAndView salva(@Valid SessaoForm form, BindingResult result) {
        ...
        if (gerenciador.validaSessao(sessao)) {
